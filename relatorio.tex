...
\section{Metodologia}
Os testes foram executados com 4 processos MPI e limite de entrada igual a 500.000.000. O tempo de execução foi medido pelo processo raiz ao final da execução, permitindo comparar o custo das diferentes estratégias de comunicação.
...
\hline
\end{tabular}
\caption{Resultados finais da versão naive.}
\end{table}

Na versão naive, o menor tempo foi obtido com \texttt{MPI\_Ssend}, enquanto o maior tempo ocorreu com \texttt{MPI\_Send}.
...
\hline
\end{tabular}
\caption{Resultados finais da versão bag of tasks.}
\end{table}

Na versão bag of tasks, o menor tempo foi obtido com \texttt{MPI\_Ssend}, e o maior tempo com \texttt{MPI\_Isend}.
