...
int main(int argc, char *argv[]) {
    ...
    // Distribua as tasks de forma dinâmica entre as threads, começando com blocos maiores e diminuindo gradualmente até blocos       mínimos de 10 tasks
    ...
    printf("Algoritmo: Bag of Tasks com Escalonamento Guiado\n");
    printf("Threads: %d\n", num_threads);
    printf("N: %lld\n", N);
